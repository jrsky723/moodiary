...
///    [cCalendarDatePicker] and provides an optional compact view where the
///    user can enter a date as a line of text.
///  * [showTimePicker], which shows a dialog that contains a Material Design
///    time picker.
///
class cCalendarDatePicker extends StatefulWidget {
  ...
  /// change the [key] to create a new instance of the [cCalendarDatePicker], and
  ...
  @override
  State<cCalendarDatePicker> createState() => _cCalendarDatePickerState();
}

class _cCalendarDatePickerState extends State<cCalendarDatePicker> {
...
class _DatePickerModeToggleButtonState
  ...
  Widget build(BuildContext context) {
    ...
    final TextTheme textTheme = isDarkMode(context)
...
/// [cCalendarDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [cCalendarDatePicker], which provides a Material Design date picker
///    interface.
///
